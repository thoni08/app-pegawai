...
@section('content')
  @php
    $statusLabel = $attendance->status_absensi
      ? ucfirst(str_replace('_', ' ', $attendance->status_absensi))
      : '-';

    $details = [
      'Nama Karyawan'   => $attendance->employee?->nama_lengkap ?? 'Tidak diketahui',
      'Tanggal'         => $attendance->tanggal ?? '-',
      'Waktu Masuk'     => $attendance->waktu_masuk ?? '-',
      'Waktu Keluar'    => $attendance->waktu_keluar ?? '-',
      'Status Absensi'  => $statusLabel,
    ];
  @endphp
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Ringkasan informasi absensi karyawan.</p>
      </div>
