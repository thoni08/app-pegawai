  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
      <div class="mb-6">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">Perbarui informasi departemen sesuai kebutuhan.</p>
      </div>
      ...
      <form action="{{ route('departments.update', $department->id) }}" method="POST" class="bg-white dark:bg-gray-900">
        @csrf
        @method('PUT')
        ...
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
          <div class="sm:col-span-2">
            ...
            <input type="text" id="nama_departemen" name="nama_departemen" value="{{ old('nama_departemen', $department->nama_departemen) }}" required
