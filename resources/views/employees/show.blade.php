...
@section('content')
  @php
    $details = [
      ...
      'Nomor Telepon'  => $employee->nomor_telepon,
  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Detail Pegawai</h1>
        <p class="text-sm text-gray-600 dark:text-gray-400">Ringkasan informasi pegawai.</p>
      </div>
